...
static const char* const kClassPathName =
    "org/mokee/platform/internal/PerformanceManagerService";
...
static void
org_mokee_platform_internal_PerformanceManagerService_launchBoost(
...
static JNINativeMethod gMethods[] = {
     {"native_launchBoost", "(ILjava/lang/String;)V",
            (void *)org_mokee_platform_internal_PerformanceManagerService_launchBoost},
};

int register_org_mokee_platform_internal_PerformanceManagerService(JNIEnv *env)
{
