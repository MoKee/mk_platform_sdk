...
import mokee.app.ILiveLockScreenChangeListener;
import mokee.app.ILiveLockScreenManager;
import mokee.app.ILiveLockScreenManagerProvider;
 ...
 * @hide
 */
public class LiveLockScreenServiceBroker extends MKSystemService {
    ...
    public String getFeatureDeclaration() {
        return MKContextConstants.Features.LIVE_LOCK_SCREEN;
    }

    @Override
    public void onStart() {
        if (DEBUG) Slog.d(TAG, "service started");
        publishBinderService(MKContextConstants.MK_LIVE_LOCK_SCREEN_SERVICE, new BinderService());
    }
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_THIRD_PARTY_APPS_CAN_START) {
            ...
            String defComponent = MKSettings.Secure.getString(mContext.getContentResolver(),
     ...
     * {@link org.mokee.platform.internal.Manifest.permission#LIVE_LOCK_SCREEN_MANAGER_PROVIDER}
     * permission.
     *
    ...
    /**
     * Enforces the
     * {@link mokee.platform.Manifest.permission#LIVE_LOCK_SCREEN_MANAGER_ACCESS_PRIVATE}
     * permission.
     */
    ...
    private void setLiveLockScreenEnabledInternal(boolean enabled) {
        ...
        MKSettings.Secure.putInt(mContext.getContentResolver(),
                MKSettings.Secure.LIVE_LOCK_SCREEN_ENABLED, enabled ? 1 : 0);
        Binder.restoreCallingIdentity(token);
    }
}
