/*
 * Copyright (c) 2011-2015 MoKee OpenSource Project
 *
...
import mokee.app.ISettingsManager;
import mokee.app.SettingsManager;
...
public class SettingsManagerService extends SystemService {
    ...
    public SettingsManagerService(Context context) {
        super(context);
        mContext = context;
        publishBinderService(MKContextConstants.MK_SETTINGS_SERVICE, mService);
    }
