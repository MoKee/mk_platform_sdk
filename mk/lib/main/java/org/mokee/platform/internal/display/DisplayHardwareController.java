...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    public boolean onStart() {
        ...
        if (mUseCABC) {
            ...
            mCABC = mHardware.get(MKHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT);
        ...
        if (mUseColorEnhancement) {
            ...
            mColorEnhancement = mHardware.get(MKHardwareManager.FEATURE_COLOR_ENHANCEMENT);
        ...
        if (mUseAutoContrast) {
            ...
            mAutoContrast = mHardware.get(MKHardwareManager.FEATURE_AUTO_CONTRAST);
    ...
    public synchronized void onSettingsChanged(Uri uri) {
        ...
        if (uri == null || uri.equals(DISPLAY_COLOR_ADJUSTMENT)) {
            System.arraycopy(
                    parseColorAdjustment(getString(MKSettings.System.DISPLAY_COLOR_ADJUSTMENT)),
    ...
    private synchronized void updateAutoContrast() {
        ...
        boolean value = getInt(MKSettings.System.DISPLAY_AUTO_CONTRAST,
        ...
        mHardware.set(MKHardwareManager.FEATURE_AUTO_CONTRAST, enabled);
    ...
    private synchronized void updateColorEnhancement() {
        ...
        boolean value = getInt(MKSettings.System.DISPLAY_COLOR_ENHANCE,
        ...
        mHardware.set(MKHardwareManager.FEATURE_COLOR_ENHANCEMENT, enabled);
    ...
    private synchronized void updateCABCMode() {
        ...
        boolean value = getInt(MKSettings.System.DISPLAY_CABC,
                (mDefaultCABC ? 1 : 0)) == 1;
        ...
        mHardware.set(MKHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT, value);
        mCABC = value;
    }
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getInt(MKSettings.System.DISPLAY_AUTO_CONTRAST,
                        (mDefaultAutoContrast ? 1 : 0)) == 1;
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putInt(MKSettings.System.DISPLAY_AUTO_CONTRAST, enabled ? 1 : 0);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getInt(MKSettings.System.DISPLAY_CABC,
                        (mDefaultCABC ? 1 : 0)) == 1;
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putInt(MKSettings.System.DISPLAY_CABC, enabled ? 1 : 0);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getInt(MKSettings.System.DISPLAY_COLOR_ENHANCE,
                        (mDefaultColorEnhancement ? 1 : 0)) == 1;
    }
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putInt(MKSettings.System.DISPLAY_COLOR_ENHANCE, enabled ? 1 : 0);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        return parseColorAdjustment(getString(MKSettings.System.DISPLAY_COLOR_ADJUSTMENT));
    }
