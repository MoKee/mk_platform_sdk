...
/**
 * The MoKeeAlarmClock class contains utilities for interacting with
 * a variety of Alarm features that the MoKee AlarmClock application
 * (based on AOSP DeskClock) supports.
 */
public class MoKeeAlarmClock {
    /**
     * The package name of the MoKee DeskClock application.
     */
    ...
    public static final String MODIFY_ALARMS_PERMISSION
            = "mokee.alarmclock.permission.MODIFY_ALARMS";

    /**
     * Allows an application to have read access to all alarms in the
     * MoKee DeskClock application.
     *
     * @see mokee.alarmclock.ClockContract
     */
    public static final String READ_ALARMS_PERMISSION
            = "mokee.alarmclock.permission.READ_ALARMS";

    /**
     * Allows an application to have write access to all alarms in the
     * MoKee DeskClock application. This is a system level permission.
     *
     * @see mokee.alarmclock.ClockContract
     * @hide
     */
    public static final String WRITE_ALARMS_PERMISSION
            = "mokee.alarmclock.permission.WRITE_ALARMS";
     ...
     *     as stored in {@link mokee.alarmclock.ClockContract.AlarmsColumns#_ID}</li>
    ...
    public static final String ACTION_SET_ALARM_ENABLED
            = "mokee.alarmclock.SET_ALARM_ENABLED";
     ...
     * {@link mokee.alarmclock.ClockContract.AlarmsColumns#_ID} for this alarm.
     * </p>
     *
     * @see #ACTION_SET_ALARM_ENABLED
     * @see #EXTRA_ENABLED
     */
    public static final String EXTRA_ALARM_ID = "mokee.intent.extra.alarmclock.ID";
     ...
     * @see #EXTRA_ALARM_ID
     */
    public static final String EXTRA_ENABLED = "mokee.intent.extra.alarmclock.ENABLED";

    /**
     * <p>
     * Retrieves an Intent that is prepopulated with the proper action and ComponentName to
     * create a new alarm in the MoKee DeskClock application.
     * </p>
     ...
     * @return The Intent to create a new alarm with the MoKee DeskClock application.
     */
