...
public class PartnerInterface {
    ...
    public static final String MODIFY_NETWORK_SETTINGS_PERMISSION =
            "mokee.permission.MODIFY_NETWORK_SETTINGS";
    ...
    public static final String MODIFY_SOUND_SETTINGS_PERMISSION =
            "mokee.permission.MODIFY_SOUND_SETTINGS";
    ...
    private PartnerInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
               MKContextConstants.Features.PARTNER) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link mokee.app.PartnerInterface}
     * @param context
    ...
    static public IPartnerInterface getService() {
        ...
        IBinder b = ServiceManager.getService(MKContextConstants.MK_PARTNER_INTERFACE);
        if (b != null) {
     ...
     * {@link mokee.media.MediaRecorder.AudioSource#HOTWORD} input.
