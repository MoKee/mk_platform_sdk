...
public class Intent {
    ...
    public static final String ACTION_THEME_RESOURCES_CACHED =
            "mokee.intent.action.THEME_RESOURCES_CACHED";
     ...
     * @hide
     */
    public static final String EXTRA_THEME_RESULT = "mokee.intent.extra.RESULT";
     ...
     * @hide
     */
    public static final String EXTRA_THEME_PACKAGE_NAME = "mokee.intent.extra.PACKAGE_NAME";
