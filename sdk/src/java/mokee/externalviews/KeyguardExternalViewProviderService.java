 ...
 * {@link mokee.platform.Manifest.permission#THIRD_PARTY_KEYGUARD} permission in their
 * manifest</p>
...
public abstract class KeyguardExternalViewProviderService extends Service {
    ...
    protected abstract class Provider {
         ...
         * @deprecated As of SDK version {@link mokee.os.Build.MK_VERSION_CODES#ELDERBERRY}
         * this does nothing.
         */
        @Deprecated
        protected final void collapseNotificationPanel() {
