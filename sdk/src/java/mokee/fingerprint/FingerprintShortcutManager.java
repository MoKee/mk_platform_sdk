...
public class FingerprintShortcutManager {
    ...
    public SparseArray<Target> getShortcuts() {
        ...
        for (String line : shortcutMappings.split("\n")) {
            ...
            switch (mapping[1]) {
                case "cmp":
                    shortcuts.put(fingerId, new ComponentTarget(mapping[2]));
                    break;
                case "shortcut":
    ...
    public class ComponentTarget extends Target {
        ...
        private ComponentTarget(String component) {
            this.component = ComponentName.unflattenFromString(component);
        }
